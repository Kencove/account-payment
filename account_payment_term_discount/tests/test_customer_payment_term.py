...
class TestLandedCostCompanyPercentage(common.TransactionCase):
    def setUp(self):
        ...
        self.payment_term = self.payment_term_model.with_user(
            ...
            dict(
                name="5%10 NET30",
                is_discount=True,
                note="5% discount if payment done within 10days, " "otherwise net",
                line_ids=[
                    (
                        0,
                        0,
    ...
    def test_customer_invoice_payment_term_discount(self):
        ...
        invoice_date = fields.Date.from_string(self.customer_invoice.date_invoice)
        ...
        self.customer_invoice2 = self.account_invoice_model.with_user(
            self.account_manager.id
        ).create(
            dict(
                name="Test Customer Invoice",
        ...
        invoice_date = fields.Date.from_string(self.customer_invoice2.date_invoice)
